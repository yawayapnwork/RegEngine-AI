...
| `LLM_PROVIDER` | `offline` | Extraction LLM provider: `offline` (deterministic local), `huggingface`, `openai`, `anthropic`. |
| `HUGGINGFACEHUB_API_TOKEN` | — | API token for Hugging Face Inference (Qwen2.5-72B-Instruct). |
