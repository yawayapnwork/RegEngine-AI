  ...
  return (
    <header className="flex items-center justify-between border-b border-ink-700 bg-ink-900 px-5 py-3">
      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center gap-2 rounded-sm border border-ink-700 bg-ink-850 px-2.5 py-1.5 text-sm text-slate-400">
        ...
        <button className="relative rounded-sm border border-ink-700 bg-ink-850 p-1.5 text-slate-400 hover:text-slate-200">
          <Bell className="h-3.5 w-3.5" />
          <span className="absolute -right-0.5 -top-0.5 h-1.5 w-1.5 rounded-full bg-rose-500" />
        </button>
        <div className="flex h-7 w-7 items-center justify-center rounded-sm border border-ink-700 bg-ink-850 font-mono text-2xs font-semibold text-slate-400">
          CO
        </div>
      </div>
    </header>
